...
require_once __DIR__."/controller/aboutTeacherEditController.php";
?>
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
      <div class="container-fluid">
          ...
          <div class="mb-0 mt-4">
              <h4><i class="fa fa-user"></i> ข้อมูลครู </h4>
          </div>
          <hr class="mt-2">
...
<script>
    ...
    function selectYear(res) {
        ...
        document.location = "aboutTeacherEdit.php?year="+input_year;
    }
    ...
    function saveAbout() {
        ...
        req.done(function (res) {
            if(res.status){
                ...
                document.location = "aboutTeacherEdit.php?year="+year;
            }else{
