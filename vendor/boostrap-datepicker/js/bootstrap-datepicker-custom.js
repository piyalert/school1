    ...
    */
    ...
    Datepicker.prototype = {
        ...
        _fill_yearsView: function (selector, cssClass, factor, step, currentYear, startYear, endYear, callback) {
            ...
            �����ʴ� �պ���ǵ��ҧ �� 2550-2559
            */
            //yearOffSet = (year>2500)?0:yearOffSet;
        ...
        fill: function () {
            ...
            var months = this.picker.find('.datepicker-months')
						.find('.datepicker-switch')
                            ...
                            �����ʴ���͹����ǵ��ҧ������� �.�. ��  ���Ҥ� 2559
                            */
							.text(this.o.maxViewMode < 2 ? monthsTitle : year + (year>2500?0:yearOffSet))
    ...
    var DPGlobal = {
        ...
        formatDate: function (date, format, language) {
            ...
            var val = {
                ...
                */
                yyyy: (date.getUTCFullYear()>2500)?(date.getUTCFullYear()):(date.getUTCFullYear()+ yearOffSet)
            };
